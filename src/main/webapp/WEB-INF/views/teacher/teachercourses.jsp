                            ...
                            <!-- 表格文字颜色和字号指定 -->
                                ...
                                <s:iterator value="#request.tchCourseList" var="tchList">
                                    <tr>
                                        ...
                                        <td><a href="tcourseExample?courseId=<s:property value="#tchList.courseId" />"><span class="glyphicon glyphicon-open tup" style="float:left;"></span></a></td>
                                                <!-- 上传和下载放在了每一格的左边 -->
                                        <td>
                                            <a href="thomework?courseId=<s:property value="#tchList.courseId" />"><span class="glyphicon glyphicon-save tdo" style="float:left;"></span></a>
                                        </td>
                                    </tr>
                                </s:iterator>
                                </tbody>
